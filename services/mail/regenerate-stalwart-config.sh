...
"${compose[@]}" exec -T stalwart sh -lc 'test -s /etc/stalwart/config.json && test -s /etc/stalwart/apply-plan.ndjson && ls -l /etc/stalwart/config.json /etc/stalwart/apply-plan.ndjson'
./apply-stalwart-plan.sh
