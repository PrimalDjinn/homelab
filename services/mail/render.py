...
def write_env(path: Path) -> None:
    ...
    values = {
        ...
        "STALWART_ACME_DNS_RFC_HOST": env("STALWART_ACME_DNS_RFC_HOST"),
        "STALWART_ACME_DNS_RFC_PORT": env("STALWART_ACME_DNS_RFC_PORT", "53"),
        "STALWART_ACME_DNS_RFC_PROTOCOL": env("STALWART_ACME_DNS_RFC_PROTOCOL", "udp"),
        "STALWART_ACME_DNS_RFC_ALGORITHM": env("STALWART_ACME_DNS_RFC_ALGORITHM", "hmac-sha256"),
        "STALWART_ACME_DNS_RFC_KEY": env("STALWART_ACME_DNS_RFC_KEY"),
        "STALWART_ACME_DNS_RFC_SECRET": env("STALWART_ACME_DNS_RFC_SECRET"),
        "STALWART_PROXY_TRUSTED_NETWORKS": env("STALWART_PROXY_TRUSTED_NETWORKS"),
        "STALWART_PROXY_AUTODETECT": "false",
        "STALWART_ALLOWED_IP": env("STALWART_ALLOWED_IP"),
        "STALWART_DNS_RESOLVER": env("STALWART_DNS_RESOLVER", "cloudflare"),
        "STALWART_DNS_USE_TLS": env("STALWART_DNS_USE_TLS", "false"),
        "STALWART_DOCKER_SOCKET_PATH": env("STALWART_DOCKER_SOCKET_PATH", "/var/run/docker.sock"),
        "STALWART_HTTP_USE_X_FORWARDED": env("STALWART_HTTP_USE_X_FORWARDED", "true"),
        "STALWART_HTTP_CORS_ALLOWED_ORIGINS": f"https://{webmail_domain}",
        "STALWART_HTTP_PERMISSIVE_CORS": env("STALWART_HTTP_PERMISSIVE_CORS", "false"),
        "STALWART_WEBMAIL_HOSTNAME": webmail_domain,
        "STALWART_HTTP_PROTOCOL": "https",
        "STALWART_TRAEFIK_ENABLED": "false",
        "STALWART_TRAEFIK_DOCKER_NETWORK": env("STALWART_TRAEFIK_DOCKER_NETWORK"),
        "STALWART_TRAEFIK_HTTPS_ENTRYPOINT": env("STALWART_TRAEFIK_HTTPS_ENTRYPOINT", "https"),
        "STALWART_TRAEFIK_SMTP_ENTRYPOINT": env("STALWART_TRAEFIK_SMTP_ENTRYPOINT", "smtp"),
        "STALWART_TRAEFIK_SMTPS_ENTRYPOINT": env("STALWART_TRAEFIK_SMTPS_ENTRYPOINT", "smtps"),
        "STALWART_TRAEFIK_IMAPS_ENTRYPOINT": env("STALWART_TRAEFIK_IMAPS_ENTRYPOINT", "imaps"),
